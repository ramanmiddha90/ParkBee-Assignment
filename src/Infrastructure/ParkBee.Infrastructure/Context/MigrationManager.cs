            ...
            using (var scope = host.Services.CreateScope())
            {
                using (var dbContext = scope.ServiceProvider.GetRequiredService<ApplicationDBContext>())
                {
                    ...
                    try
                    {
                        ...
                        dbContext.Set<Address>().AddRange(addresses);

                        var garage1door1 = new Door(garage1Door1Id, "Human", "Human Door", true, "garage1Door1IPId");
                        ...
                        dbContext.Set<GarageDetail>().Add(
                                new GarageDetail(garage1, "Garage1", "Front", 100, 30, address1, true, false, garage1Doors));

                        dbContext.Set<GarageDetail>().Add(
                               new GarageDetail(garage2, "Garage2", "back", 100, 30, address2, true, false, garage2Doors));
                    ...
                    {
                        //swallog exception - should be run only once
